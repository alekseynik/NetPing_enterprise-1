        ...
        <?php foreach ( $r->posts as $recent_post ) : ?>
            ...
            <li>
                ...
                <div class="entry-wrapper">
                    <a href="<?php the_permalink( $recent_post->ID ); ?>" class="widget-news-title" <?php echo $aria_current; ?>><?php echo $title; ?></a>
                    <a href="<?php the_permalink( $recent_post->ID ); ?>">Читать дальше →</a>
                </div>
            </li>
        <?php endforeach; ?>
    </ul>
