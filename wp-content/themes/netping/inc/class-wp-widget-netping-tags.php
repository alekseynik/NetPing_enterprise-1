...
class WP_Widget_Netping_Tags extends WP_Widget {
...
public function __construct() {
    $widget_ops = array(
        'description'                 => 'Выводит теги списком, отсортированным по популярности',
        'customize_selective_refresh' => true,
    );
    parent::__construct( 'pop_tags', 'Популярыне теги', $widget_ops );
}
...
public function widget( $args, $instance ) {
    ...
    $current_cat_ids = '';
    $link_type = 'link_params';
    if ( get_queried_object() instanceof WP_term ) {
        $current_cat_ids = get_tags_in_use(get_queried_object()->term_id, 'id' );
